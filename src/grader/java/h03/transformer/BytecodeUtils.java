...
final class BytecodeUtils {
    ...
    private static final String ASSIGNMENT_ID = "h03";
...
//        }
        ...
        visitor.visitTypeInsn(Opcodes.NEW, ASSIGNMENT_ID + "/transformer/MethodInterceptor$Invocation");
...
//        }
        ...
        visitor.visitMethodInsn(Opcodes.INVOKESPECIAL,
            ASSIGNMENT_ID + "/transformer/MethodInterceptor$Invocation",
            "<init>",
        ...
        visitor.visitMethodInsn(Opcodes.INVOKESTATIC,
            ASSIGNMENT_ID + "/transformer/MethodInterceptor",
            "addInvocation",
            "(L" + ASSIGNMENT_ID + "/transformer/MethodInterceptor$Invocation;)V",
            false);
